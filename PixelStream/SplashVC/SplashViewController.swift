...
//  PixelStream
//
//  Created by Liz-Mary on 25.12.2024.
//
...
final class SplashViewController: UIViewController {
    ...
    private func showAuthScreen() {
        ...
        if let authVC = storyboard.instantiateViewController(withIdentifier: "isLogin") as? AuthViewController {
            // Создаем навигационный контроллер с AuthViewController как корневым контроллером
